...
const commands = {
    aboutme: {
        cmd: 'aboutme',
        res: 'About Me:<br># <span class="red">Real Name:</span> Lawson</span><br># <span class="red">Location:</span> US, Texas<br><br># <span class="red">Bio:</span><br><span class="pink"><br>My names Lawson.<br>I am obsessed with everything related to computers and cyber security!<br>Use the command `links` to learn more about my socials<br></span><br><span class="red">Programming/Markup Languages:</span> HTML, CSS, JS, PHP, C++, C#, PY, JAVA, UNIX, TS, RUST, SQL.<br></span><br><span class="red">Libraries/Frameworks:</span> NodeJS, ExpressJS, ReactJS, ElectronJS, Angular2 +, MongoDB, NextJS, Gatsby, Unity, VueJS, Bootstrap, Redis.<br></span><br><span class="red">Other Skills:</span> Git, Github, GitLab, NPM, Photoshop, Apache, Yarn, Nginx, VS Code, Linux, Windows.<br></span>'
    },
    links: {
        cmd: 'links',
        res: 'Links:<br># <span class="red"><a href="https://discord.com/users/527167786200465418" target="_blank"><u>Discord</u></a></span> - My Discord Account.<br># <span class="red"><a href="https://github.com/oyuh" target="_blank"><u>Github</u></a></span> - My Github.<br># <span class="red"><a href="https://steamcommunity.com/id/maybelmao/" target="_blank"><u>Steam</u></a></span> - You can find me there <span class="green">Online</span> most of the time.<br># <span class="red"><a href="https://twitter.com/oyuhL" target="_blank"><u>My Twitter</u></a></span> - I tweet a lot</span><br># <span class="red">'
    },
    donate: {
        cmd: 'donate',
        res: 'BTC: <span class="red">3AguiDamdB9k9DGBkPPMQETybDs8514AU5</span><br>Etherium: <span class="red">0xe1c9400743689C5D6f47220e81fA517bEdE29590</span><br>PayPal: <span class="red"><a href="https://paypal.me/lawsonhart">paypal.me/lawsonhart</a></span>'
    },
    apps: {
        cmd: 'apps',
        res: 'App List:<br># <span class="red"><a href="https://lawsonhart.me/apps/1" target="_blank"><u>Discord Picture Art </u></a></span> - Create Art and Paste it in Discord.<br># <span class="red"><a href="https://lawsonhart.me/apps/2" target="_blank"><u>Classic 2048</u></a></span> - Play the classic 2048 Game.<br># <span class="red"><a href="https://lawsonhart.me/apps/3" target="_blank"><u>Flappy Bird</u></a></span> - Play the classic flappy bird game.<br># <span class="yellow"> Message me on discord to suggest an application to be added!</span><br><span class="red">'
    },
    help: {
        cmd: 'help',
        res: 'Available commands:<br><br># <span class="red">aboutme</span> - Some information about me.<br># <span class="red">clear</span> - Really, it just clears the terminal.<br># <span class="red">links</span> - Links for others sites.<br># <span class="red">insta [Link]</span> - Get original instagram picture.<br># <span class="red">donate</span> - Links to donate to me.<br># <span class="red">apps</span> - To view my apps I  have hosted.'
    }
}

var prephraseRoot = '<span class="red">root@lawsonhart.me</span>:<span class="blue">~</span># ';
var prephrase = '<span class="red">visitor@lawsonhart.me</span>:<span class="blue">~</span># ';
...
function launchCommandAsRoot(command) {
    var res = '';
    if (command === './welcome.sh') res = 'Welcome to <span class="red">lawsonhart.me</span>!<br><br></span>Ubuntu Version: <span class="red"> 20.04(x86_64)</span><span class="red"></span><br>Terminal Updated: <span class="red">11/13/2021</span><br><span class="red">Type `help` for more details on the commands</span>'
    else {
...
$('form').on('submit', function(e) {
    ...
    try {
        ...
        if (root > 0) {
            ...
            if (vInput.startsWith("./")) {
                if (vInput === "./root/welcome.sh") {
                    ...
                    launchCommandAsVisitor({
                        cmd: vInput,
                        res: '<div><p>lawsonhart.me: ' + vInput + ': No such file or directory</p></div>'
                    });
                }
                ...
                if (typeof loginArray[2] !== "undefined") {
                    if (loginArray[2] === "visitor") {
                        ...
                        if (typeof loginArray[4] !== "undefined" && MD5(loginArray[4]) === "03lawhar35512") {
                            root = 1;
                            res = '';
                        }
                    } else {
                        res = 'lawsonhart.me: No passwd entry for user ' + loginArray[2] + '';
                    }
                    launchCommandAsVisitor({
                ...
                if (vInput === "music play") {
                    ...
                    launchCommandAsVisitor({
                        cmd: vInput,
                        res: '<div><p>[ <span class="red">lawsonhart.me</span> ] Usage: music [play/stop/link]</p></div>'
                    });
                }
            }
            /*else if (vInput.startsWith("friend")) {
				if (vInput === "friend joffrey") {
					...
					launchCommandAsVisitor({
						cmd: vInput,
						res: '<div><p>[ <span class="red">lawsonhart.me.xyz</span> ] Usage: friend [name/list]</p></div>'
					});
				}
			}*/
                ...
                launchCommandAsVisitor({
                    cmd: $('input').val(),
                    res: '<div><p>Unable to access control/command!</p></div>'
                });
            } else if (vInput.trim() !== "") {
        ...
        if (root > 0) {
            launchCommandAsRoot({
                cmd: $('input').val(),
                res: '<div><p>lawsonhart.me: ' + $('input').val() + ': command not found</p></div>'
            });
        } else {
            launchCommandAsVisitor({
                cmd: $('input').val(),
